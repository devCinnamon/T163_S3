...
private:
	...
	float kFrictionCoefficientFloor = 8;

	/*
	 * Generally, multiplication of that two vars below will give Force
	 * value, because we know that : Force = mass * acceleration
	*/ 
	float massKg = 30;
	float accelerationGravity = 98;

};

#endif /* defined (__PLAY_SCENE__) */9