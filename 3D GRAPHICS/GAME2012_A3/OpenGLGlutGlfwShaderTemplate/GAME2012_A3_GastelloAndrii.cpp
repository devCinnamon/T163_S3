//***************************************************************************
//
// GAME2012_A3_GastelloAndrii.cpp by Andrii Gastello (C) 2021 All Rights Reserved.
//
...
void resetView()
{
	position = glm::vec3(6.0f, -1.0f, 5.0f); // Super pulled back because of grid size.
...
void init(void)
{
	...
	glClearColor(0.0, 0.5, 0.5, 1.0); // black background
...
void display(void)
{
	...
	transformObject(glm::vec3(1.0f, 1.0f, 1.0f), XY_AXIS, angle++, glm::vec3(6.0f, 0.0f, 0.0f));
	glDrawElements(GL_TRIANGLES, g_cube.NumIndices(), GL_UNSIGNED_SHORT, nullptr);
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow("GAME2012_A3_GastelloAndrii");
