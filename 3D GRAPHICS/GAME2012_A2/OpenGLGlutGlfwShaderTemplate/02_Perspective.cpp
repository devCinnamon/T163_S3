...
#define YX_AXIS glm::vec3(-1,-0.9,0)
#define SPEED 0.25f

enum keyMasks {
	KEY_FORWARD =		0b00000001,		// 0x01 or   1	or   01
	KEY_BACKWARD =		0b00000010,		// 0x02 or   2	or   02
	KEY_LEFT =          0b00000011,     // 0x03 or   3	or   03
	KEY_RIGHT =         0b00000100,     // 0x04 or   4	or   04
	KEY_UP =            0b00000101,     // 0x05 or   5	or   05
	KEY_DOWN =          0b00000110,     // 0x06 or   6	or   06
	KEY_MOUSECLICKED =	0b00000111,		// 0x07 or	 7  or   07
...
void display(void)
{
	...
	glBindVertexArray(vao);
		...
		transformObject(scale, XY_AXIS, angle += 1.0f, glm::vec3(0.0f, 0.45f, 0.0f));
		...
		transformObject(scale, YX_AXIS, angle += 1.0f, glm::vec3(0.0f, -0.45f, 0.0f));
		drawCube();
		drawWire(); // Draw wires over cubes.
