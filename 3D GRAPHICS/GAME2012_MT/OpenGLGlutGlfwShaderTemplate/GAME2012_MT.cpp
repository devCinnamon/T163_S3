//***************************************************************************
// GAME2012_MT.cpp by Gastello Andrii - 101324434
//
...
GLshort cube_indices[] = {
	...
	// side 6.
	20, 21, 22, 23,				// 11, 10, 12, 13,
	// side 7.
	24, 25, 26, 27,				// 13, 12, 1, 0,
	// top
	28, 29, 30, 31,	32, 33, 34,	// 1, 12, 10, 9, 6, 5, 2
	// bottom
	35, 36, 37, 38, 39, 40, 41	// 3, 4, 7, 8, 11, 13, 0
};
...
GLfloat cube_vertices[] = {
	...
	0.3f, -0.9f, 0.9f,		// 4. (copy of old 3)
	0.3f, 0.9f, 0.9f,	    // 5. (copy of old 2)
	0.3f, 0.9f, 0.9f,		// 6.
	0.3f, -0.9f, 0.9f,		// 7.

	0.9f, -0.9f, 0.3f,		// 8. (copy of old 4)
	0.9f, 0.9f, 0.3f,    // 9. (copy of old 5)
	-0.3f, 0.9f, 0.9f,		// 10. (copy of old 6)
	-0.3f, -0.9f, 0.9f,		// 11. (copy of old 7)

	0.9f, -0.9f, -0.3f,		// 12. (copy of old 7)
	0.9f, 0.9f, -0.3f,		// 13. (copy of old 6)
	-0.9f, 0.9f, 0.3f,		// 14. (copy of old 9)
	-0.9f, -0.9f, 0.3f,		// 15. (copy of old 8)

	0.3f, -0.9f, -0.9f,		// 16. (copy of old 8)
	0.3f, 0.9f, -0.9f,    // 17. (copy of old 9)
	-0.9f, 0.9f, -0.3f,		// 18. (copy of old 10)
	-0.9f, -0.9f, -0.3f,		// 19. (copy of old 11)

	-0.3f, -0.9f, -0.9f,		// 20. (copy of old 11)
	-0.3f, 0.9f, -0.9f,		// 21. (copy of old 10)
	0.0f, 0.9f, -0.9f,		// 22. (copy of old 12)
	0.0f, -0.9f, -0.9f,		// 23. (copy of old 13)

	-0.9f, -0.9f, 0.0f,		// 24. (copy of old 13)
	-0.9f, 0.9f, 0.0f,		// 25. (copy of old 12)
	0.9f, 0.9f, -0.3f,		// 26. (copy of old 1)
	0.9f, -0.9f, -0.3f,		// 27. (copy of old 0)

	-0.3f, 0.9f, 0.9f,		// 28. (copy of old 1)
	0.3f, 0.9f, 0.9f,		// 29. (copy of old 12)
	0.3f, 0.9f, 0.9f,		// 30. (copy of old 10)
	0.9f, 0.9f, 0.3f,		// 31. (copy of old 9)
	0.9f, 0.9f, 0.3f,		// 32. (copy of old 6)
	0.9f, 0.9f, -0.3f,		// 33. (copy of old 5)
	0.9f, -0.9f, -0.3f,		// 34. (copy of old 2)

	-0.3f, -0.9f, 0.9f,		// 35. (copy of old 3)
	0.3f, -0.9f, 0.9f,		// 36. (copy of old 4)
	0.3f, -0.9f, 0.9f,		// 37. (copy of old 7)
	0.9f, -0.9f, 0.3f,		// 38. (copy of old 8)
	0.9f, -0.9f, 0.3f,		// 39. (copy of old 11)
	0.9f, -0.9f, -0.3f,		// 40. (copy of old 13)
	0.9f, 0.9f, -0.3f,		// 41. (copy of old 0)
};
...
void drawCube()
{
	...
	glDrawElements(GL_POLYGON, 36, GL_UNSIGNED_SHORT, 0);
}
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow("MidTerm Exam Project - Gastello Andrii - 101324434");
